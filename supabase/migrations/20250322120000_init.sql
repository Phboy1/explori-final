...
create table if not exists public.profiles (
  ...
  role text not null default 'user' check (role in ('patient', 'staff', 'user')),
...
-- Cities (locations + coordinates for distance / recommendations)
...
-- Seed (same data as public/data/cities.csv)
